...
class MageMods_SupportSuite_Model_Ticket_Priority
{
    const LOWEST  = 1;
    const LOW     = 2;
    const NORMAL  = 3;
    ...
    {
        return array(
            self::LOWEST  => Mage::helper('supportsuite')->__('Lowest'),
            self::LOW     => Mage::helper('supportsuite')->__('Low'),
            self::NORMAL  => Mage::helper('supportsuite')->__('Normal'),
            self::HIGH    => Mage::helper('supportsuite')->__('High'),
            self::HIGHEST => Mage::helper('supportsuite')->__('Highest'),
        );
    }
