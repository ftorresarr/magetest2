...
class MageMods_SupportSuite_Model_Observer
{
    public function contactForm()
    {
        if (Mage::helper('supportsuite')->getTicketOverrideForm()) {
            Mage::app()->getResponse()->setRedirect(Mage::getUrl('supportsuite/ticket/form'))->sendResponse();
