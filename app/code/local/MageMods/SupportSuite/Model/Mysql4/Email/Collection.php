...
class MageMods_SupportSuite_Model_Mysql4_Email_Collection
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function loadUniqueIds()
    {
        ...
        $idsSelect->columns(
            'main_table.unique_id'
        );
        $idsSelect->where('main_table.unique_id IS NOT NULL');
