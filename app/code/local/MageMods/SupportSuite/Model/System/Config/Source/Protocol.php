...
class MageMods_SupportSuite_Model_System_Config_Source_Protocol
{
    public function toOptionArray()
    {
        return array(
            array('value' => 'POP3', 'label' => Mage::helper('supportsuite')->__('POP3')),
            array('value' => 'IMAP', 'label' => Mage::helper('supportsuite')->__('IMAP'))
        );
    }
}
