...
class MageMods_SupportSuite_Block_Adminhtml_Customer_Edit_Tab_Ticket
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function getMainButtonsHtml()
    {
        $button = $this->getLayout()
            ...
            ->setData(array(
                ...
                'onclick' => "setLocation('" . $this->getUrl('supportsuiteadmin/adminhtml_ticket/new', array('customer_id' => Mage::registry('current_customer')->getId())) . "')",
                'class'   => 'task'
            ))->toHtml();
    ...
    {
        return $this->getUrl('supportsuiteadmin/adminhtml_ticket/customerTicket', array('customer_id' => Mage::registry('current_customer')->getId()));
    }
